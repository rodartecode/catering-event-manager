...
/**
 * Mock a kitchen station for component tests.
 */
export function mockStation(
  overrides: Partial<{
    id: number;
    name: string;
    type: string;
...
/**
 * Mock a production task for component tests.
 */
export function mockProductionTask(
  overrides: Partial<{
    id: number;
    eventId: number;
  ...
  return {
    ...
    name: `Test Prep Task ${id}`,
    prepType: 'chop' as string,
    durationMinutes: 30,
    offsetMinutes: -240,
