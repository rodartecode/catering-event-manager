...
Cross-entity search capability enabling users to find events, clients, tasks, and resources from a unified search interface. Includes a global search endpoint, per-entity ILIKE filtering on list procedures, a debounced search bar component, and a dedicated search results page.
